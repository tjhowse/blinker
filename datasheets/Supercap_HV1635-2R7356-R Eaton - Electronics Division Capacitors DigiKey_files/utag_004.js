//tealium universal tag - utag.loader ut4.46.202201192112, Copyright 2022 Tealium.com Inc. All Rights Reserved. 
...
// 509 - Feedback sub domain Consent Check
...
if ((location.hostname.indexOf("digikey.cn") <= 0) && (typeof jQuery !== 'undefined')) {
...
if (typeof utag == "undefined" && !utag_condload) {
  ...
  utag.cfg = {
    ...
    utid: "digikey/main/202201192112"
  };
  utag.cfg.v = utag.cfg.template + "202201192112";
  try{var _gaq=_gaq || [];var pageTracker=pageTracker || {_trackEvent:function(c,d,e,f,g){g={ga_eventCat:c,ga_eventAction:d,ga_eventLabel:e,ga_eventValue:f};utag.link(g,null,[214]);},_trackPageview:function(c){_gaq.push(['_trackPageview',c?c:null]);}}}catch(e){};utag.cond={101:0,106:0,116:0,117:0,118:0,121:0,126:0,131:0,132:0,135:0,136:0,137:0,138:0,140:0,141:0,142:0,143:0,23:0,27:0,2:0,43:0,63:0,67:0,79:0,80:0,82:0,8:0,90:0,91:0,97:0,98:0};
...
case '67':try{c[67]|=(typeof d['order_id']!='undefined'&&d['dom.domain'].toString().toLowerCase().indexOf('.cn'.toLowerCase())>-1)}catch(e){utag.DB(e)}; break;
...
utag.assignVideoSource = function (b) {
    try {
        if ((typeof b['video_source'] == 'undefined' && typeof utag.data['video_source'] == 'undefined') || utag.data['video_source'] == '_') {
            if (utag.data['ref_page_type'] === 'SP' && utag.data['ref_page_sub_type'] === 'SP') { utag.data['video_source'] = 'Supplier Portal'; }
            else if (utag.data['page_type'] === 'SP' && utag.data['page_sub_type'] === 'SCP') { utag.data['video_source'] = 'Supplier Portal'; }
            else if (utag.data['ref_page_type'] === 'CP') { utag.data['video_source'] = 'Careers'; }
            else if (utag.data['page_type'] === 'MK') { utag.data['video_source'] = 'Maker'; }
            else if ((utag.data['ref_page_type'] === 'DT' && utag.data['ref_page_sub_type'] === 'RE') || (utag.data['ref_page_type'] === 'RE' && utag.data['ref_page_sub_type'] === 'DT')) { utag.data['video_source'] = 'Development Tools'; }
            else if ((utag.data['ref_page_type'] === 'DT' && utag.data['ref_page_sub_type'] === 'BFA') || (utag.data['ref_page_type'] === 'DT' && utag.data['ref_page_sub_type'] === 'LP') || (utag.data['ref_page_type'] === 'DT' && utag.data['ref_page_sub_type'] === 'BQR')) { utag.data['video_source'] = 'Design Tools'; }
            else if (utag.data['ref_page_type'] === 'RE' && utag.data['ref_page_sub_type'] === 'DKE') { utag.data['video_source'] = 'Resources'; }
            else if (utag.data['ref_page_type'] === 'BLG') { utag.data['video_source'] = 'Blog - The Circuit'; }
            else if (utag.data['ref_page_type'] === 'FS' && utag.data['ref_page_sub_type'] === 'CS') { utag.data['video_source'] = 'Content Search'; }
            else if (utag.data['ref_page_type'] === 'FS' && utag.data['ref_page_sub_type'] === 'PH') { utag.data['video_source'] = 'Product Highlight Library'; }
            else if ((utag.data['ref_page_type'] === 'FS' && utag.data['ref_page_sub_type'] === 'PTM') || utag.data['ref_page_type'] === 'PTM') { utag.data['video_source'] = 'PTM'; }
            else if ((utag.data['ref_page_type'] === 'FS' && utag.data['ref_page_sub_type'] === 'VL') || (utag.data['ref_page_type'] === 'VI' && utag.data['ref_page_sub_type'] === 'VL') || (utag.data['ref_page_type'] === 'VL' && utag.data['ref_page_sub_type'] === 'VP')) { utag.data['video_source'] = 'Video Library'; }
            else if (utag.data['ref_page_type'] === 'HP') { utag.data['video_source'] = 'DK Homepage'; }
            else if (utag.data['ref_page_type'] === 'IDA') { utag.data['video_source'] = 'Industrial Automation'; }
            else if (utag.data['ref_page_type'] === 'PS' && utag.data['ref_page_sub_type'] === 'PD') { utag.data['video_source'] = 'Part Detail'; }
            else if (utag.data['ref_page_type'] === 'RDL') { utag.data['video_source'] = 'Reference Design Library'; }
            else if (utag.data['ref_page_type'] === 'RE' && utag.data['ref_page_sub_type'] === 'IOT') { utag.data['video_source'] = 'IoT Solutions'; }
            else if (utag.data['ref_page_type'] === 'SP' && utag.data['ref_page_sub_type'] === 'PH') { utag.data['video_source'] = 'Product Highlight Library'; }
            else if (utag.data['ref_page_type'] === 'DSP' && utag.data['ref_page_sub_type'] === 'DSP') { utag.data['video_source'] = 'Design Service Provider Page'; }
            else if (typeof ['page_content_group'] != 'undefined' && decodeURIComponent(utag.data['page_content_group']) == 'Product Highlight') { utag.data['video_source'] = 'Product Highlight Library'; }
            else if (typeof ['page_content_group'] != 'undefined' && decodeURIComponent(utag.data['page_content_group']) == 'Scheme It') { utag.data['video_source'] = 'Scheme It'; }
            else if (utag.data['ref_page_type'] === 'DT' && utag.data['ref_page_sub_type'] === 'SI') { utag.data['video_source'] = 'Scheme It'; }
            else if (location.hostname.indexOf("developer.digikey.com") > -1) { utag.data['video_source'] = 'API Solutions'; }
            else if (typeof ['page_content_group'] != 'undefined' && decodeURIComponent(utag.data['page_content_group']) == 'Blogs') { utag.data['video_source'] = 'Blog - The Circuit'; }
            else if (typeof ['page_content_group'] != 'undefined' && decodeURIComponent(utag.data['page_content_group']) == 'Resources') { utag.data['video_source'] = 'Resources'; }
            else if (utag.data['ref_page_type'] === 'TZ') { utag.data['video_source'] = 'Techzones'; }
            else if (utag.data['ref_page_sub_type'] === 'SP') { utag.data['video_source'] = 'Supplier Portal'; }
            else if ((utag.data['ref_page_type'] === 'DYC' && utag.data['ref_page_sub_type'] === 'PG') || (utag.data['ref_page_type'] === 'ERC' && utag.data['ref_page_sub_type'] === 'HP') || (utag.data['ref_page_type'] === 'RCO' && utag.data['ref_page_sub_type'] === 'RDX') || (utag.data['ref_page_type'] === 'RE' && utag.data['ref_page_sub_type'] === 'RE') || (utag.data['ref_page_type'] === 'TZ' && utag.data['ref_page_sub_type'] === 'SB') || (utag.data['ref_page_type'] === 'PS' && utag.data['ref_page_sub_type'] === 'CAT') || (utag.data['ref_page_type'] === 'PS' && utag.data['ref_page_sub_type'] === 'FAM') || (utag.data['ref_page_type'] === 'HE' && utag.data['ref_page_sub_type'] === 'HE')) { utag.data['video_source'] = 'Other'; }
            else if (typeof b["qp.video_source"] != 'undefined') { utag.data['video_source'] = b["qp.video_source"]; }
            else if (typeof b["qp.WT.z_video_source"] != 'undefined') { utag.data['video_source'] = b["qp.WT.z_video_source"]; }
            else { utag.data['video_source'] = utag.data['ref_page_type'] + '_' + utag.data['ref_page_sub_type']; }
        }
        else {
...
utag.dkView = function (data) {
    try {
        try {
            ...
            // convert China orders over limit
            if(data.page_site === 'CN' && data.order_currency === 'CNY' && data.hasOwnProperty('order_subtotal')) {
                if( data.order_subtotal > 3000000 )
...
utag.dk = {
    ...
    AssignGT: function (b, gid, site, dlang, region, dcur) {
        ...
        b.order_currency = utag.data['order_currency'] || 'USD';
    },
...
if (/digikeytest\.digikey/i.test(dom) || /digikeydev\.digikey/i.test(dom) || /preprod\.digikey/i.test(dom)) {
    ...
    dk.AssignGT(b, '49', 'IN', 'en', 'APAC', 'INR');
...
function(a,b){ try{ if(1){
// 548 - Supplier Cookies
// Process the Supplier cookie if exists
...
//    b['manufacturer_part_number'] = array[2];
    switch (b.st_campaign) {
        ...
        case "0E56F8FC522C4D628442528DBC6EE":
            b.st_campaign_supplier_id = "541";
            b.st_campaign_supplier_name="Vishay";
            break;
        case "5AD338A57804493BB6F7F0965949C8E0":
            b.st_campaign_supplier_id = "285";
            b.st_campaign_supplier_name="TDK";
            break;
        default:
...
function(a,b){ try{ if(1){
// 497 - Set Page Type Data for China Site
...
utag.evergageTable = {};
var cookiePrefix = 'Supplier Cookies - '
var homepageBanner = 'Homepage Banner'
var productSearch = 'Product Search Ad'
var homepageClick = 'Homepage Banner Click (e)'
var partSearchClick = 'Part Search Banner Click (e)'

// Analog Devices
utag.evergageTable['MHlVe']=[cookiePrefix + 'Analog Devices',homepageBanner,homepageClick]
utag.evergageTable['hr425']=[cookiePrefix + 'Analog Devices',productSearch,partSearchClick]

// Molex
utag.evergageTable['ORkOm']=[cookiePrefix + 'Molex',homepageBanner,homepageClick]
utag.evergageTable['QF7OB']=[cookiePrefix + 'Molex',productSearch,partSearchClick]

// ONSemi
utag.evergageTable['nUzP0']=[cookiePrefix + 'ONSemi',homepageBanner,homepageClick]
utag.evergageTable['XcUiS']=[cookiePrefix + 'ONSemi',productSearch,partSearchClick]

// Recom
utag.evergageTable['VxDgx']=[cookiePrefix + 'Recom',homepageBanner,homepageClick]
utag.evergageTable['C09C7']=[cookiePrefix + 'Recom',productSearch,partSearchClick]

// ST Micro
utag.evergageTable['xZYRq']=[cookiePrefix + 'ST Micro',homepageBanner,homepageClick]
utag.evergageTable['C2OJn']=[cookiePrefix + 'ST Micro',productSearch,partSearchClick]

// TDK-Lambda
utag.evergageTable['lsK90']=[cookiePrefix + 'TDK',homepageBanner,homepageClick]
utag.evergageTable['FnaNt']=[cookiePrefix + 'TDK',productSearch,partSearchClick]

// Texas Instruments
utag.evergageTable['XyvF3']=[cookiePrefix + 'TI',homepageBanner,homepageClick]
utag.evergageTable['MaEYA']=[cookiePrefix + 'TI',productSearch,partSearchClick]

// Vishay
utag.evergageTable['A8tOy']=[cookiePrefix + 'Vishay',homepageBanner,homepageClick] 
utag.evergageTable['TLwHT']=[cookiePrefix + 'Vishay',productSearch,partSearchClick]

// Wurth
utag.evergageTable['2VfmF']=[cookiePrefix + 'Wurth',homepageBanner,homepageClick]       // 11/18/21 - 02/28/22
utag.evergageTable['T8XNx']=[cookiePrefix + 'Wurth',productSearch,partSearchClick]      // 11/18/21 - 02/28/22

// Supplier Web2Web Navigation
...
utag.ga['sendProductListforPurchase'] = function (data) {
    ...
    for (idx; idx < data.part_id_a.length; idx++) {
        ...
        var tmpTtl = data.line_item_price_a[idx] * data.part_qty_a[idx];
...
utag.ga['sendPurchaseEvent'] = function () {
    ...
    var env = (utag.data['tealium_environment'] === 'qa') ? 'Sandbox' : 'Production';
    var transdata = {
        //id: u.order_weborder_number,      Replaced with pre_order_id Oct1821
        id: u.pre_order_id,
        affiliation: "",
...
function(a,b){ try{ if(1){
// 410 - Cookie Personalization Tags - Run for all Events
...
if (cookie !== null && typeof cookie[1] != 'undefined') {
    b.order_currency = utag.data.order_currency = cookie[1];
} 
...
function(a,b){ try{ if(1){
// 448 - Event Time - Track Evergage Clicks
...
function(a,b){ try{ if(1){
// 455 - Map UTM Campaign Tags (no webtrends)
...
// 458 - Fixup Events - Fixup MyDigikey
    ...
    if (a === 'view') {
        ...
        switch (utag.dkConCatPageType()) {
            case 'PS-PD':
                ...
                /*
                // 20220114 - check for add to cart button
                var checkArr = ['order-form', 'add-to-cart-btn', 'pricing-table-container']
                var descArr = ['Quantity', 'Add to Cart Button', 'Pricing Table' ]
                var errArr = []
                for (i = 0; i < checkArr.length; i++) {
                    if (!document.querySelector('[data-testid="' + checkArr[i] + '"]')) {
                        errArr.push(descArr[i])
                    }
                }
                if (errArr.length) {
                    var errMsg = errArr.toString()
                    utag.link({ event_category: 'Debug Info', ref_page_event: 'PDP - Pricing table missing: ' + errMsg, event_label: 'PDP - Missing Pricing' });
                }
                */
                break;
            case 'PS-FAM':
...
function(a,b){ try{ if(1){
// 494 - View - Part Detail Page - First Price Break
if (a === 'view') {
...
//utag.data['part_search_filter'] = "";
  ...
  utag.handler.cfg_extend=[{"id":"398","end":0,"blr":1,"alr":0,"bwq":0},{"bwq":0,"alr":0,"blr":1,"end":0,"id":"551"},{"id":"552","bwq":0,"alr":0,"blr":1,"end":0},{"alr":0,"end":0,"blr":1,"bwq":0,"id":"553"},{"id":"550","bwq":0,"alr":0,"blr":1,"end":0},{"alr":0,"end":0,"blr":1,"bwq":0,"id":"518"},{"id":"548","bwq":0,"blr":1,"end":0,"alr":0},{"bwq":0,"blr":1,"end":0,"alr":0,"id":"497"},{"id":"421","alr":0,"end":0,"blr":1,"bwq":0},{"alr":0,"end":0,"blr":1,"bwq":0,"id":"423"},{"id":"447","bwq":0,"blr":1,"end":0,"alr":0},{"bwq":0,"blr":1,"end":0,"alr":0,"id":"451"},{"bwq":0,"blr":1,"end":0,"alr":0,"id":"457"},{"id":"459","alr":0,"end":0,"blr":1,"bwq":0},{"id":"466","bwq":0,"blr":1,"end":0,"alr":0},{"bwq":0,"alr":0,"blr":1,"end":0,"id":"471"},{"id":"472","bwq":0,"blr":1,"end":0,"alr":0},{"bwq":0,"blr":1,"end":0,"alr":0,"id":"479"},{"bwq":0,"blr":1,"end":0,"alr":0,"id":"527"},{"id":"528","end":0,"blr":1,"alr":0,"bwq":0},{"id":"535","alr":0,"end":0,"blr":1,"bwq":0},{"id":"3","bwq":0,"blr":0,"end":0,"alr":1},{"bwq":0,"alr":1,"blr":0,"end":0,"id":"569"},{"alr":1,"end":0,"blr":0,"bwq":0,"id":"397"},{"alr":1,"end":0,"blr":0,"bwq":0,"id":"410"},{"id":"429","bwq":0,"blr":0,"end":0,"alr":1},{"id":"433","alr":1,"end":0,"blr":0,"bwq":0},{"alr":1,"end":0,"blr":0,"bwq":0,"id":"439"},{"end":0,"blr":0,"alr":1,"bwq":0,"id":"445"},{"id":"448","end":0,"blr":0,"alr":1,"bwq":0},{"id":"455","alr":1,"end":0,"blr":0,"bwq":0},{"end":0,"blr":0,"alr":1,"bwq":0,"id":"456"},{"bwq":0,"alr":1,"blr":0,"end":0,"id":"435"},{"id":"570","bwq":0,"blr":0,"end":0,"alr":1},{"bwq":0,"blr":0,"end":0,"alr":1,"id":"458"},{"id":"462","end":0,"blr":0,"alr":1,"bwq":0},{"bwq":0,"blr":0,"end":0,"alr":1,"id":"464"},{"id":"465","end":0,"blr":0,"alr":1,"bwq":0},{"id":"467","alr":1,"end":0,"blr":0,"bwq":0},{"alr":1,"end":0,"blr":0,"bwq":0,"id":"475"},{"end":0,"blr":0,"alr":1,"bwq":0,"id":"478"},{"id":"483","end":0,"blr":0,"alr":1,"bwq":0},{"id":"491","alr":1,"end":0,"blr":0,"bwq":0},{"alr":1,"end":0,"blr":0,"bwq":0,"id":"494"},{"alr":1,"end":0,"blr":0,"bwq":0,"id":"499"},{"end":0,"blr":0,"alr":1,"bwq":0,"id":"505"},{"id":"512","alr":1,"end":0,"blr":0,"bwq":0},{"id":"514","bwq":0,"blr":0,"end":0,"alr":1},{"id":"557","alr":0,"end":1,"blr":0,"bwq":0},{"alr":0,"end":1,"blr":0,"bwq":0,"id":"480"},{"end":1,"blr":0,"alr":0,"bwq":0,"id":"484"},{"bwq":0,"alr":0,"blr":0,"end":1,"id":"558"}];
  utag.loader.initcfg = function(){
    utag.loader.cfg={"304":{load:1,send:1,v:201805151502,wait:0,tid:20067},"269":{load:(utag.cond[91] && utag.cond[141] && utag.cond[118]),send:1,v:202201172042,wait:1,tid:7110},"211":{load:(utag.cond[141] && utag.cond[132] && utag.cond[90]),send:1,v:202201172042,wait:1,tid:7110},"172":{load:(utag.cond[142] && utag.cond[63] && utag.cond[136]),send:1,v:202002141927,wait:1,tid:20078},"192":{load:(utag.cond[142] && utag.cond[67] && utag.cond[136]),send:1,v:202111102033,wait:1,tid:11003},"204":{load:(utag.cond[142] && utag.cond[136] && utag.cond[97] && utag.cond[138]),send:1,v:202003022139,wait:1,tid:6026},"207":{load:(utag.cond[142] && utag.cond[79] && utag.cond[136] && utag.cond[2]),send:1,v:202002141927,wait:1,tid:7117},"208":{load:(utag.cond[142] && utag.cond[80] && utag.cond[136] && utag.cond[2]),send:1,v:202002141927,wait:1,tid:7117},"214":{load:(utag.cond[136] && utag.cond[82]),send:1,v:201907222054,wait:1,tid:7001},"267":{load:(utag.cond[141] && utag.cond[118] && utag.cond[131] && utag.cond[101]),send:1,v:202201172042,wait:1,tid:7110},"268":{load:(utag.cond[142] && utag.cond[136] && utag.cond[97] && utag.cond[98]),send:1,v:202002141927,wait:1,tid:6026},"272":{load:(utag.cond[142] && utag.cond[136] && utag.cond[23]),send:1,v:202002141927,wait:1,tid:25019},"274":{load:(utag.cond[142] && utag.cond[136] && utag.cond[27]),send:1,v:202002141927,wait:1,tid:20067},"279":{load:utag.cond[106],send:1,v:202007202104,wait:1,tid:20067},"288":{load:1,send:1,v:201801010024,wait:1,tid:20010},"301":{load:(utag.cond[136] && utag.cond[116] && utag.cond[43]),send:1,v:201904081403,wait:1,tid:20078},"303":{load:(utag.cond[136] && utag.cond[117]),send:1,v:202010282035,wait:1,tid:3158},"312":{load:(utag.cond[121] && utag.cond[142] && utag.cond[136] && utag.cond[138]),send:1,v:202110132038,wait:1,tid:2045},"316":{load:(utag.cond[142] && utag.cond[136] && utag.cond[8] && utag.cond[126]),send:1,v:202201172042,wait:1,tid:7132},"321":{load:(utag.cond[142] && utag.cond[136] && utag.cond[138] && utag.cond[126]),send:1,v:202201172042,wait:1,tid:7132},"335":{load:(utag.cond[142] && utag.cond[79] && utag.cond[136] && utag.cond[8]),send:1,v:202002141927,wait:1,tid:11003},"336":{load:(utag.cond[142] && utag.cond[136]),send:1,v:202002141927,wait:1,tid:12047},"337":{load:(utag.cond[91] && utag.cond[136]),send:1,v:202110132038,wait:1,tid:17003},"338":{load:(utag.cond[137] && utag.cond[136]),send:1,v:202110132038,wait:1,tid:17003},"339":{load:(utag.cond[142] && utag.cond[8] && utag.cond[27]),send:1,v:202002141927,wait:1,tid:14022},"340":{load:(utag.cond[142] && utag.cond[136] && utag.cond[138] && utag.cond[27]),send:1,v:202002141927,wait:1,tid:14022},"370":{load:(utag.cond[142] && utag.cond[91] && utag.cond[8] && utag.cond[27]),send:1,v:202112202031,wait:1,tid:20010},"343":{load:(utag.cond[142] && utag.cond[91] && utag.cond[138] && utag.cond[27]),send:1,v:202112202031,wait:1,tid:20010},"344":{load:(utag.cond[121] && utag.cond[142] && utag.cond[136] && utag.cond[8]),send:1,v:202110132038,wait:1,tid:2063},"351":{load:(utag.cond[142] && utag.cond[136] && utag.cond[135]),send:1,v:202002141927,wait:1,tid:20010},"353":{load:(utag.cond[142] && utag.cond[136] && utag.cond[140] && utag.cond[97] && utag.cond[138]),send:1,v:202111292037,wait:1,tid:11023},"355":{load:(utag.cond[142] && utag.cond[136] && utag.cond[135] && utag.cond[138]),send:1,v:202008072046,wait:1,tid:20010},"358":{load:utag.cond[143],send:1,v:202008242125,wait:1,tid:7125},"364":{load:(utag.cond[142] && utag.cond[136]),send:1,v:202111031949,wait:1,tid:4049},"372":{load:(utag.cond[142] && utag.cond[79] && utag.cond[136] && utag.cond[140] && utag.cond[138]),send:1,v:202111292037,wait:1,tid:11023}};
utag.loader.cfgsort=["304","269","211","172","192","204","207","208","214","267","268","272","274","279","288","301","303","312","316","321","335","336","337","338","339","340","370","343","344","351","353","355","358","364","372"];
  }
utag.loader.initcfg();
}
...
utag.collectSpecElements = function (element, sElements, cntrl) {
    ...
    var elId = element.id
    var elHref = element.href
    var elDataTestID = element.getAttribute('data-testid')
    var elDataAtag = element.getAttribute('data-atag')
    // General

    // for Header Nav
    if (clName.indexOf('featured__flyout__text') >= 0) sElements['Flyout'] = element;  //old
    if (clName.indexOf('flymenu__featured') >= 0) sElements['Flyout'] = element;
    if (clName.indexOf('cta-button') >= 0) sElements['Flyout'] = element;//old
    if (typeof elHref !== 'undefined' && elHref.toLowerCase().indexOf('logout') >= 0) sElements['Logout'] = element;
    if (typeof elHref !== 'undefined' && elHref.toLowerCase().indexOf('/help/authorized-distributor') >= 0) sElements['ECIA Distributor'] = element;

    // for Additional Header
    if (clName.indexOf('country-drawer') >= 0 && clName.indexOf('country-drawer closed') < 0) sElements['Change Country'] = element;
    if (clName.indexOf('lang-dropdown-list') >= 0) sElements['Change Language'] = element;
    if (clName.indexOf('cur-dropdown-list') >= 0) sElements['Change Currency'] = element;
    if (clName.indexOf('currency-prompt-update-preferences-button dk-btn__primary') >= 0) sElements['Change Currency-Update Preferences'] = element;
    if (clName.indexOf('dk-link bottom-link') >= 0 && typeof elHref != 'undefined' && elHref.toLowerCase().indexOf('/resources/local-support') >= 0) sElements['Change Currency-Help and Support'] = element;

    // for Part Search Family Page
    if (clName.indexOf('lnkDatasheet') >= 0) sElements['Asset'] = element;
    if (clName.indexOf('tr-qtyAvailable') >= 0) sElements['Help for Parts'] = element;
    if (clName.indexOf('tr-packaging') >= 0) sElements['Help for Parts'] = element;
    if (clName.indexOf('tr-series') >= 0) sElements['View Series'] = element;
    if (clName.indexOf('tr-vendor') >= 0) sElements['Select Manufacturer'] = element;
    if (clName.indexOf('catfiltertopitem') >= 0) sElements['Cat Header'] = element;
    if (clName.indexOf('newProductCategory') >= 0) sElements['Cat New Product'] = element;
    if (elId === 'addtoorderbutton' || elId === 'update-addToOrder-btn') sElements['Add Part'] = element;

    // for Part Detail Page
    if (elId === 'btnDuplicateOrder') sElements['Duplicate Order'] = element; // Added Aug1721
    if (clName.indexOf('button btnLeadTime') >= 0) sElements['Lead Time'] = element;
    if (clName.indexOf('link') >= 0 && typeof elHref != 'undefined' && elHref.toLowerCase().indexOf('/local-support#faqs6') >= 0) sElements['Select Learn More'] = element; //for PDP & SC

    // for Part Search Category Page
    if (clName.indexOf('chosen-results') >= 0) {
    ...
    if (clName.indexOf('suggestions--part-number') >= 0) sElements['Part Number Type Ahead'] = element;
    if (clName.indexOf('search__suggestions') >= 0 && clName.indexOf('suggestions--part-number') < 0) sElements['Categories Type Ahead'] = element;
    if (elDataTestID === 'filter-box-inner-ref') sElements['Filter on Supplier'] = element;
    if (elDataTestID === 'data-table-0-product-number') sElements['Select Part'] = element;
    if (elDataAtag === 'tr-manufacturer' || elDataAtag === 'tr-supplier') sElements['Select Manufacturer'] = element;
    if (elDataAtag === 'tr-series') sElements['View Series'] = element;
    if (elDataTestID === 'per-page-selector') sElements['Change Number of Results Displayed'] = element;
    if (elDataTestID === 'download-table-button') sElements['Download Table'] = element;
    if (elDataTestID === 'marketplace-messages') sElements['View Marketplace Message'] = element;
    if (elDataTestID === 'pagination-container') sElements['Change Page in Search Results'] = element;
    if (elDataTestID === 'help-icon-trigger') sElements['Help for Parts'] = element;
    if (elDataTestID === 'overview-supplier') sElements['Link to Supplier'] = element;
    if (elDataTestID === 'marketplace-messages') sElements['View Marketplace Message'] = element;
    if (elDataTestID === 'compare-button') sElements['Click Compare Parts'] = element;
    if (elDataTestID === 'shared-toggle') sElements['Hide or Expose Shared Attributes'] = element;
    if (elDataTestID === 'remove-column-button') sElements['Remove Part from Comparison'] = element;
    if (elDataTestID === 'compare-table') sElements['Link from Product Comparison'] = element;

    // for Shopping Cart
    if (clName.indexOf('button-checkout') >= 0) sElements['Checkout'] = element;
    if (elId === 'btnAddToCart' || elId === 'btnAddToNewCart') sElements['Upload File'] = element;
    if (elId === 'btnImportParts') sElements['Add Part List'] = element;
    if (clName.indexOf('btnAddToCart') >= 0) sElements['Add Part Manually'] = element;
    if (elId === 'WC_SubmitOrderBtn' || elId === 'WC_SubmitOrderBtn2') sElements['Submit Order'] = element;  //for China - Existing
    if ((clName.indexOf('submit-button') > -1 && utag.data.page_content_sub_group == "Order Preview") || elId === 'checkout-continue-btn') sElements['Submit Order'] = element; //Updated for China Aug2721
    if (clName.indexOf('cartRowShippedByMessage') >= 0) sElements['View Marketplace Message'] = element;
    // Share My Cart with EKOM button click
    if (elId === 'ekomButton') sElements['Share My Cart with EKOM'] = element;
    // for Supplier Centers
    if (clName.indexOf('supplier-result-container') >= 0) {
    ...
    // for PCB Builder
    if (clName.indexOf('dk-tab-item') >= 0) sElements['Tab Item'] = element;

    // for BOM
    if (elId === 'btnAddToCart') sElements['BOM Add to Cart'] = element;
    if (elId === 'apply-assemblies-btn') sElements['BOM Apply Assemblies'] = element;
    // for Evergage Personalization
    if (elId.indexOf('evergage-tooltip') >= 0) sElements['Evergage Click'] = element;
    // for Help
    if (clName.indexOf('expand-section-link') >= 0) {
...
utag.sendDebuggingTag = function (data) {
    ...
    switch (utag.dkConCatPageType()) {
        case 'MYL-LST': // Added for myList buttons Nov032021
            var rpeArr = ['Upload File', 'Add Parts', 'Create Quote', 'Add to Cart']
            if (rpeArr.includes(data.ref_page_event)) {
                utag.link({ event_category: 'Debug Info', ref_page_event: data.ref_page_event + ' Clicked', event_label: pageDat })
            }
            break;
    }
}
...
utag.postDCSpecializedFunc = function (tags, sElements, cntrl, event) {
    ...
    var refPgEvent = tags.ref_page_event;
    var fixUpSC = typeof utag.fixUpShoppingCart

    if (refPgEvent === 'Header Nav') {
        if (typeof utag.getHeaderNavHrchy !== 'undefined') utag.getHeaderNavHrchy(tags, sElements, event);
    } else if (refPgEvent === 'Footer Nav' || refPgEvent === 'Footer Nav - Contact Us') {
    ...
    } else if (fixUpSC !== 'undefined') {
        if ((pgType === 'SC' && pgSubType === 'POR' && utag.data['page_site'] === 'CN') ||
            (pgType === 'PS' && pgSubType === 'PD' && pgTitle === 'Part Detail') ||
            (pgType === 'MDK' && pgSubType === 'RO' && pgTitle === 'Order Status') || // Added Aug1621 for utm_data_do
            (pgType === 'SC' && pgSubType === 'CO' && pgTitle === 'Add Part') || // Added Aug1621 for Checkout )
            (pgType === 'SC' && pgSubType === 'SCAD' && pgTitle === 'Shopping Cart - AddressPreview')) {// Updated Aug2521 for utm_data_so 
            cntrl.eventType = utag.fixUpShoppingCart(tags, sElements, cntrl.eventType)
        }
    } else if (pgType === 'SP' && pgSubType === 'SP') {
        if (typeof utag.fixUpSuppliers !== 'undefined') utag.fixUpSuppliers(tags, sElements);
    } else if (pgType === 'RE' || pgType === 'PCB') {
...
utag.generateTag = function (sElements, href, tags, cntrl) {
    ...
    } else if (pgType === 'BOM' && pgSubType === 'BOM') {
        if (typeof utag.generateMyDigikeyTags !== 'undefined') cntrl.tagSent = utag.generateMyDigikeyTags(tags, sElements)
    } else if (pgType === 'SC' && pgSubType === 'CO') {
        if (typeof utag.generateShoppingCartTags !== 'undefined') cntrl.tagSent = utag.generateShoppingCartTags(tags, sElements, href)
    } else if (pgType === 'SP' && pgSubType === 'SP') {
        if (typeof utag.generateSupplierTags !== 'undefined') cntrl.tagSent = utag.generateSupplierTags(tags, sElements, href)
    } else if (pgType === 'PS' && pgSubType.match(/^CAT$|^FAM$|^PD$|^SR$|^PCAT$|^CMP$/)) {
        if (typeof utag.generatePartSearchTags !== 'undefined') cntrl.tagSent = utag.generatePartSearchTags(tags, sElements, href)
    }
    if (typeof utag.generateFixUpAllPages !== 'undefined') cntrl.tagSent = utag.generateFixUpAllPages(tags, sElements);
}
...
utag.processTags = function (a, b, c, d, e) {
    /* added 20220110 - check if right click
    if (a.button !== 0) {
            ...
            try {
                ...
                if (cntrl.trackableElement && htmlIdx < 5) {
                    ...
                    if (typeof cType !== 'undefined' &&
                        (cType.match(/^a$|^button$|^div$|^li$|^ul$/i) !== null) || (cType.toLowerCase() === 'input' && element.id === "addtoorderbutton")) {
...
try{var link=b;// 216 - Generate OffSite and Download Events in Google
(function () {
    var data = {};
    utag.dkStdVars(data);
    data['not_a_pageview'] = '1';
