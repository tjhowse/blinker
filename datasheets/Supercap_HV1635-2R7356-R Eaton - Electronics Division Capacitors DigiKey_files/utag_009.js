...
//~~tc: Check for the existence of an Advertiser ID before converting it to an array
...
//tealium universal tag - utag.sender.4049 ut4.0.202111031949, Copyright 2021 Tealium.com Inc. All Rights Reserved.
try {
  (function (id, loader) {
    var u = {"id" : id};
  ...
  u.map={"order_currency":"custom.u1","order_subtotal_in_usd":"custom.u2,order_total","pre_order_id":"order_id"};
  u.extend=[];
    ...
    u.send = function (a, b) {
      if (u.ev[a] || u.ev.all !== undefined) {
        ...
        u.data = {
          ...
          "advertiser_id" : "DC-1401983",
          "activity_group" : "digik907",
          "activity" : "onlin268",
          "counting_method" : "",
          "fire_purchase" : "true",
          "custom_scripts" :  "true",
